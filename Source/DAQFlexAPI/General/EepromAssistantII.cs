...
{
    internal class EepromAssistantII : EepromAssistant
    {
        ...
        {
            return m_driverInterface.ReadDeviceMemory2(memReadCmd, memOffset, memOffsetLength, count, out buffer);
        }
        ...
        /// <returns></returns>
        //==============================================================================================================================================================================
        internal override ErrorCodes WriteDeviceMemory(ushort memAddrCmd, byte memWriteCmd, ushort memoryOffset, ushort memOffsetLength, ushort bufferOffset, byte[] buffer, byte count)
        {
            return m_driverInterface.WriteDeviceMemory2((byte)memWriteCmd, memoryOffset, memOffsetLength, bufferOffset, buffer, count);
        }
    }
}
