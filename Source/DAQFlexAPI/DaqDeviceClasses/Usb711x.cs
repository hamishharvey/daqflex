...
namespace MeasurementComputing.DAQFlex
{
   //===========================================================================
   /// <summary>
   /// Base class for  USB-711x series
   /// </summary>
   /// <param name="deviceInfo">A device info object</param>
   //===========================================================================
   internal class Usb711x : DaqDevice
   {
      ...
      //===========================================================================
      internal Usb711x(DeviceInfo deviceInfo)
         : base(deviceInfo, 0x07e)
      {
      }
      ...
      protected override ErrorCodes RestoreDeviceCaps()
      {
         ...
         errorCode = m_driverInterface.WriteDeviceMemory1(m_memAddrCmd, m_memWriteCmd, memoryOffset, 2, 0, count, 2);
         
         #if DEBUG
         count[0]=0;
         //errorCode = m_driverInterface.ReadDeviceMemory1(m_memAddrCmd, m_memReadCmd, memoryOffset, 2, 2, out buffer);
         m_driverInterface.ReadDeviceMemory1(m_memAddrCmd, m_memReadCmd, memoryOffset, m_memOffsetLength, 2, out count);
         #endif
         ...
         {
            errorCode = m_driverInterface.WriteDeviceMemory1(m_memAddrCmd, m_memWriteCmd, memoryOffset, 2, bufferOffset, buffer, size);
         ...
         errorCode = m_driverInterface.WriteDeviceMemory1(m_memAddrCmd, m_memWriteCmd, memoryOffset, 2, bufferOffset, buffer, (byte)partialBlock);
...
#if DEBUG
         m_driverInterface.ReadDeviceMemory1(m_memAddrCmd, m_memReadCmd, m_devCapsOffset, m_memOffsetLength, 2, out count);
#endif
         return errorCode;
      }
